...
summary: Bevor Sie Solaris Host Data LUNs mit Sun Volume Manager von ONTAP 7-Mode auf Clustered ONTAP umstellen, müssen Sie die für den Übergangsprozess erforderlichen Informationen sammeln. 
---
...
----
. Suchen Sie auf dem Host den Gerätenamen für die LUN:
+
`*#sanlun lun show*`
...
----
. Auflisten und Aufzeichnen der SVM und anschließende Abrufen der mit der SVM verbundenen Festplatten:
+
`*metaset*`
